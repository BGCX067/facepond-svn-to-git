...
import com.soa.facepond.service.UserExistsException;
import com.soa.facepond.service.UserManager;
import com.soa.facepond.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.soa.facepond.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
    ...
    public List<User> findUsersWithYearlyFrequency(){
    	return userDao.findUsersWithYearlyFrequency();
    }
    
    public List<User> findUsersWithMonthlyFrequency(){
    	return userDao.findUsersWithMonthlyFrequency();
    }

	public List<User> findUsersWithDailyFrequency(){
		return userDao.findUsersWithDailyFrequency();
	}

	public List<User> findUsersWithHourlyFrequency(){
		return userDao.findUsersWithHourlyFrequency();
	}
}
